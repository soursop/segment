...
public class ConditionsMatcherTest {
    ...
    public void testGetNotConditionsIds() throws Exception {
        ...
        ConditionsMatcher matcher = new ConditionsMatcher(new Parameter[]{Parameter.of(DATA_SOURCE, conditionses)});
    ...
    public void failEmptyInDataSource() throws Exception {
        ConditionsMatcher matcher = new ConditionsMatcher(new Parameter[]{Parameter.of(DATA_SOURCE, null, "20160419")});
    ...
    public void testFindConditionIds() throws Exception {
        ...
        ConditionsMatcher matcher = new ConditionsMatcher(new Parameter[]{Parameter.of("", conditionses, "20160328")});
    ...
    public void testDurationConditions() throws Exception {
        ...
        ConditionsMatcher matcher = new ConditionsMatcher(new Parameter[]{parameter});
    ...
    public void testRepeatFrequencyConditions() throws Exception {
        ConditionsMatcher matcher = new ConditionsMatcher(new Parameter[]{getRepeatFRequencyParameter()});
...
//        System.out.println(conditionsIds.getConditionIds());
    ...
    private void testMatchTime(ConditionsMatcher matcher, List<String> conditionIds, String[] rows, int date) throws Exception {
